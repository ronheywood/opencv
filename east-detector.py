#Efficient and accurate scene text (EAST) extraction
...
image = cv2.imread('images/text-recognition/example_01.jpg')
orig = image.copy()
(H, W) = image.shape[:2]
...
path_to_east_trained_model = 'frozen_east_text_detection.pb'
net = cv2.dnn.readNet(path_to_east_trained_model)
